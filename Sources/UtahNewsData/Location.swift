...
public struct Location: AssociatedData, Codable, Hashable, Equatable, JSONSchemaProvider { // Added JSONSchemaProvider conformance
...
public struct Coordinates: BaseEntity, Codable, Hashable, Equatable, JSONSchemaProvider { // Added JSONSchemaProvider conformance
